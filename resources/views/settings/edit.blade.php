...
<div class="card">
    <div class="card-body">
        <form action="{{ route('settings.store') }}" method="post">
            ...
            <div class="form-group">
                <label for="warning_quantity">Alerta de Quantidade Minima</label>
                <input type="text" name="warning_quantity" class="form-control @error('warning_quantity') is-invalid @enderror" id="warning_quantity" placeholder="Alerta de Quantidade Minima" value="{{ old('warning_quantity', config('settings.warning_quantity')) }}">
