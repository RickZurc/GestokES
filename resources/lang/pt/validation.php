...
return [
    ...
    | como as regras de tamanho. Sinta-se livre para ajustar estas mensagens.
    |
    */
    ...
    | especificar uma linha de linguagem personalizada para uma regra de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar o marcador de posição
    | do atributo por algo mais legível, como "Endereço de E-mail" em vez
    | de "email". Isso simplesmente ajuda a tornar a mensagem mais expressiva.
    |
    */
